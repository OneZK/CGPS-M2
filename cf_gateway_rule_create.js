...
await createZeroTrustRule(wirefilterDNSExpression.slice(0, -4), "ZGPS Filter Lists", ["dns"]);
...
if (BLOCK_BASED_ON_SNI) {
  ...
  // .slice removes the trailing ' or '
  await createZeroTrustRule(wirefilterSNIExpression.slice(0, -4), "ZGPS Filter Lists - SNI Based Filtering", ["l4"]);
}
